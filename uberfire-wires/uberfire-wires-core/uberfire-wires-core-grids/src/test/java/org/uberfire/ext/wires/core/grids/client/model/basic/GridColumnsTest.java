...
import static org.uberfire.ext.wires.core.grids.client.model.basic.BaseGridTest.Expected.*;
...
public class GridColumnsTest extends BaseGridTest {
    ...
    public void testAppendColumn() {
        ...
        assertGridIndexes( data,
                           new BaseGridTest.Expected[][]{
                                   { build( "(0, 0)" ), build( "(1, 0)" ), build( null ) },
                                   { build( "(0, 1)" ), build( "(1, 1)" ), build( null ) }
                           } );
    ...
    public void testInsertColumn() {
        ...
        assertGridIndexes( data,
                           new BaseGridTest.Expected[][]{
                                   { build( "(0, 0)" ), build( null ), build( "(1, 0)" ) },
                                   { build( "(0, 1)" ), build( null ), build( "(1, 1)" ) }
                           } );
    ...
    public void testDeleteColumnThenInsertColumn() {
        ...
        assertGridIndexes( data,
                           new BaseGridTest.Expected[][]{
                                   { build( "(0, 0)" ), build( null ), build( "(2, 0)" ) },
                                   { build( "(0, 1)" ), build( null ), build( "(2, 1)" ) }
                           } );
    ...
    public void testInsertx2ColumnThenDeletex2Column() {
        ...
        final GridColumn<String> tgc1 = new MockGridColumn<String>( "col4",
                                                                    100 );
        data.insertColumn( 1,
                           tgc1 );
        ...
        assertGridIndexes( data,
                           new BaseGridTest.Expected[][]{
                                   { build( "(0, 0)" ), build( null ), build( "(1, 0)" ), build( "(2, 0)" ) },
                                   { build( "(0, 1)" ), build( null ), build( "(1, 1)" ), build( "(2, 1)" ) }
                           } );
        ...
        final GridColumn<String> tgc2 = new MockGridColumn<String>( "col5",
                                                                    100 );
        data.insertColumn( 1,
                           tgc2 );
        ...
        assertGridIndexes( data,
                           new BaseGridTest.Expected[][]{
                                   { build( "(0, 0)" ), build( null ), build( null ), build( "(1, 0)" ), build( "(2, 0)" ) },
                                   { build( "(0, 1)" ), build( null ), build( null ), build( "(1, 1)" ), build( "(2, 1)" ) }
                           } );
    ...
    public void testMoveColumnThenDelete() {
        ...
        assertGridIndexes( data,
                           new Expected[][]{
                                   { build( "(2, 0)" ), build( "(0, 0)" ), build( "(1, 0)" ) },
                                   { build( "(2, 1)" ), build( "(0, 1)" ), build( "(1, 1)" ) }
                           } );
