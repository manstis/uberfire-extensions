...
public class GridGroupingTest extends BaseGridTest {
    ...
    public void testRemoveRow0() {
        ...
        final IGridData.Range rows = data.deleteRow( 0 );
        assertEquals( 0,
                      rows.getMinRowIndex() );
        assertEquals( 0,
                      rows.getMaxRowIndex() );
    ...
    public void testRemoveRow1() {
        ...
        final IGridData.Range rows = data.deleteRow( 1 );
        assertEquals( 1,
                      rows.getMinRowIndex() );
        assertEquals( 3,
                      rows.getMaxRowIndex() );
    ...
    public void testRemoveRow2() {
        ...
        final IGridData.Range rows = data.deleteRow( 2 );
        assertEquals( 1,
                      rows.getMinRowIndex() );
        assertEquals( 3,
                      rows.getMaxRowIndex() );
    ...
    public void testRemoveRow3() {
        ...
        final IGridData.Range rows = data.deleteRow( 3 );
        assertEquals( 1,
                      rows.getMinRowIndex() );
        assertEquals( 3,
                      rows.getMaxRowIndex() );
    ...
    public void testRemoveRow4() {
        ...
        final IGridData.Range rows = data.deleteRow( 4 );
        assertEquals( 4,
                      rows.getMinRowIndex() );
        assertEquals( 4,
                      rows.getMaxRowIndex() );
    ...
    @Test
    public void testGroupedMoveRowUp1() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
    ...
    @Test
    public void testGroupedMoveRowUp2() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
        final IGridColumn<String> gc2 = new MockMergableGridColumn<String>( "col1",
    ...
    @Test
    public void testGroupedMoveRowUp3() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
        final IGridColumn<String> gc2 = new MockMergableGridColumn<String>( "col1",
        ...
        final IGridRow row3 = new BaseGridRow();
        final IGridRow row4 = new BaseGridRow();
        final IGridRow row5 = new BaseGridRow();
        data.appendRow( row0 );
        data.appendRow( row1 );
        data.appendRow( row2 );
        data.appendRow( row3 );
    ...
    @Test
    public void testGroupedMoveRowUp4() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
        final IGridColumn<String> gc2 = new MockMergableGridColumn<String>( "col1",
    ...
    @Test
    public void testGroupedMoveRowUp5() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
        final IGridColumn<String> gc2 = new MockMergableGridColumn<String>( "col1",
    ...
    @Test
    public void testGroupedMoveRowDown1() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
        final IGridColumn<String> gc2 = new MockMergableGridColumn<String>( "col1",
    ...
    @Test
    public void testGroupedMoveRowDown2() {
        final IGridData data = new BaseGridData();
        final IGridColumn<String> gc1 = new MockMergableGridColumn<String>( "col1",
                                                                            100 );
        final IGridColumn<String> gc2 = new MockMergableGridColumn<String>( "col1",
