...
import static org.uberfire.ext.wires.core.grids.client.model.mergable.BaseMergableGridTest.Expected.*;

public class MergableGridColumnsTest extends BaseMergableGridTest {
    ...
    public void testAppendColumn() {
        ...
        assertGridIndexes( data,
                           ...
                           new boolean[]{ false, false },
                           new BaseMergableGridTest.Expected[][]{
    ...
    public void testInsertx2ColumnThenDeletex2Column() {
        ...
        final MergableGridColumn<String> tgc1 = new MockMergableGridColumn<String>( "col4",
                                                                                    100 );
        data.insertColumn( 1,
                           tgc1 );
        ...
        final MergableGridColumn<String> tgc2 = new MockMergableGridColumn<String>( "col5",
                                                                                    100 );
        data.insertColumn( 1,
                           tgc2 );
