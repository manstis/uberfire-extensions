 ...
 */
public interface IHasSingletonDOMElementResource extends IHasDOMElementResources {

    /**
     * Flush the content of a DOMElement to the underlying model. Releasing and removing the DOMElement.
     */
    void flush();
