...
public class BaseGridRendererHelper {
    ...
    public RenderingInformation getRenderingInformation() {
        final Rectangle bounds = getVisibleBounds();
    ...
    public ColumnInformation getColumnInformation( final double cx ) {
        ...
        final RenderingInformation ri = getRenderingInformation();
        final List<IGridColumn<?>> columns = model.getColumns();
        final RenderingBlockInformation bodyBlockInformation = ri.getBodyBlockInformation();
        final RenderingBlockInformation floatingBlockInformation = ri.getFloatingBlockInformation();
    ...
    public static class RenderingInformation {
        ...
        RenderingInformation( final Rectangle bounds,
