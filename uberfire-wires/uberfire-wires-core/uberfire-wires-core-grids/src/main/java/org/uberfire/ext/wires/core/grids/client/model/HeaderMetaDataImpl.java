...
public class HeaderMetaDataImpl implements IGridColumn.HeaderMetaData {
    ...
    public HeaderMetaDataImpl( final String columnTitle ) {
        this( columnTitle,
    ...
    public boolean equals( Object o ) {
        ...
        if ( !( o instanceof HeaderMetaDataImpl ) ) {
            return false;
        }

        HeaderMetaDataImpl that = (HeaderMetaDataImpl) o;
