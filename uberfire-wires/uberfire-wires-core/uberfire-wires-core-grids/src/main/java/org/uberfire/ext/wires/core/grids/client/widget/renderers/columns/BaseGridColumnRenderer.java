...
public abstract class BaseGridColumnRenderer<T> implements IGridColumnRenderer<T> {
    ...
    public Group renderHeader( final List<IGridColumn.HeaderMetaData> headerMetaData,
        ...
        final IGridColumn<?> column = visibleBlockColumns.get( context.getColumnIndex() );
    ...
    @SuppressWarnings("unchecked")
    private int getBlockStartColumnIndex( final List<IGridColumn<?>> allColumns,
    ...
    @SuppressWarnings("unchecked")
    private int getBlockEndColumnIndex( final List<IGridColumn<?>> allColumns,
                                        final IGridColumn.HeaderMetaData headerMetaData,
                                        final int headerRowIndex,
                                        final int headerColumnIndex ) {
    ...
    private double getBlockOffset( final List<IGridColumn<?>> allColumns,
        ...
        for ( int blockColumnIndex = blockStartColumnIndex; blockColumnIndex < headerColumnIndex; blockColumnIndex++ ) {
            final IGridColumn column = allColumns.get( blockColumnIndex );
            if ( column.isVisible() ) {
    ...
    private double getBlockWidth( final List<IGridColumn<?>> allColumns,
                                  final int blockStartColumnIndex,
    ...
    @Override
    public Group renderColumn( final IGridColumn<?> column,
