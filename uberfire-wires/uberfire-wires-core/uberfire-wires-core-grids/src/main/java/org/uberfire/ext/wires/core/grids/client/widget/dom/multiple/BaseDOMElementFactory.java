 ...
 */
public abstract class BaseDOMElementFactory<T, W extends Widget, E extends BaseDOMElement<T, W>> implements IMultipleDOMElementFactory<W, E> {
    ...
    public BaseDOMElementFactory( final IGridLayer gridLayer,
