...
public class WiresGridsScreen extends Composite implements ISelectionManager {
    ...
    public void setup() {
        ...
        for ( int idx = 0; idx < 10; idx++ ) {
            ...
            grid1Column.setColumnGroup( "grid1ColumnGroup" + grid1ColumnGroupSuffix );
            grid1Column.setMinimumWidth( minimumColumnWidth );
            grid1Column.setMaximumWidth( maximumColumnWidth );
        ...
        for ( int idx = 0; idx < 2; idx++ ) {
            ...
            grid3Column.setMoveable( isMoveable );
        ...
        grid3Column2.setColumnGroup( grid3ColumnGroup1 );
        ...
        grid3Column3.setColumnGroup( grid3ColumnGroup1 );
        ...
        grid3Column4.setColumnGroup( grid3ColumnGroup1 );
